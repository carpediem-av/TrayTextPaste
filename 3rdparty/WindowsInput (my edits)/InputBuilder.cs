//Добавлены правки, заключенные в строки versetty>>> и <<<versetty
                                    ...
                                    new KEYBDINPUT
                                        {
                                            ...
                                            //versetty>>> added KeyboardFlag.ScanCode to both
                                            Flags = IsExtendedKey(keyCode) ? (UInt32) KeyboardFlag.ExtendedKey | (UInt32)KeyboardFlag.ScanCode : (UInt32)KeyboardFlag.ScanCode,
                                            //<<<versetty
                                            Time = 0,
